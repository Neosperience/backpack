...
profiling your Panorama application, and remote view the output of your model.
 ...
 - :ref:`telescope-api` contains an abstract base class to stream OpenCV frames to a GStreamer
   pipeline

    - :ref:`kvs-api` is a concrete Telescope implementation that streams the output of the AWS
      Panorama application to AWS Kinesis Video Streams service.
    - :ref:`rtsp-api` is another Telescope implementation that serves a sequence of OpenCV images as
